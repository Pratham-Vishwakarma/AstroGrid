...
function SideBar({ setCalender, setDay, setWeek, setHelp }) {
  return (
    <div className='flex items-end'>
        <div className="w-11 lg:w-12 h-[85vh] border-r-[1px] flex items-center border-gray-600 bg-gradient-to-b hover:bg-gradient-to-br from-transparent to-zinc-950 hover:to-80% absolute z-50 overflow-hidden bg-opacity-25 hover:bg-gray-900 hover:bg-opacity-95 hover:w-44 transition-all duration-200 ease-in-out hover:delay-1000">
            ...
            <div className='flex flex-col justify-center h-[95%] gap-[12%] ml-[1vw] lg:ml-[0.8vw] xl:ml-[0.6vw] sm:ml-[1.5vw]'>
                ...
                <div className='flex flex-row items-center gap-4 cursor-pointer' onClick={setWeek}>
                ...
                <div className='flex flex-row items-center gap-4 cursor-pointer' onClick={setHelp}>
