...
function SideBar({ setCalender, setDay, setWeek, setHelp }) {
  return (
    <div className='flex items-end'>
        <div className="w-11 lg:w-12 h-[85vh] border-r-[1px] flex items-center border-gray-600 bg-gradient-to-b hover:bg-gradient-to-br from-transparent to-zinc-950 hover:to-80% absolute z-50 overflow-hidden bg-opacity-25 hover:bg-gray-900 hover:bg-opacity-60 hover:w-44 transition-all duration-200 ease-in-out hover:delay-1000">
